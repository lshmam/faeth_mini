...
const blogPosts = [
  {
    ...
    excerpt: "Exploring the core principles that make minimal interfaces effective and engaging for users.",
    date: "2023-12-15",
  ...
  },
  {
    ...
    excerpt: "Examining trends and predictions for how creative agencies will evolve in the next decade.",
    date: "2023-10-17",
  ...
  },
  {
    ...
    excerpt: "A detailed look at our process for transforming a client's brand identity from concept to execution.",
    date: "2023-09-22",
